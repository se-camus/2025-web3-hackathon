...
let uniqueID = "2";
  ...
  const connectWallet = async () => {
      try {
          ...
          const result = await contract.methods.safeMint(uniqueID, sendAddress).send({ from: address });
  ...
  connectButton.className = "select-button"; // Assuming the button in mainVotingPage.html has this class
