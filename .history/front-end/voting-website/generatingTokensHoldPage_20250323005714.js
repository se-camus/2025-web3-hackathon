...
let uniqueID = 200;
  ...
  async function mintToken(uniqueId, toAddress) {
    if (typeof window.ethereum !== "undefined") {
        const contractAddress = "0x963ecBf662A9c5859d734F65eB2760cD928B8a8B";  // Replace with actual contract address

        // Encode the function call
        const encodedData = eth.abi.encodeFunctionCall({
            name: "safeMint",
            type: "function",
            inputs: [
        ...
        const transactionParameters = {
            to: contractAddress,
            from: toAddress, // Current connected wallet
            data: encodedData
        };
